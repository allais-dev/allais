          ...
          <div className="mx-auto max-w-4xl">
            ...
            {pagesLoading ? (
              <div className="flex items-center justify-center py-12">
                <div className="h-8 w-8 animate-spin rounded-full border-b-2 border-t-2 border-white"></div>
                <p className="ml-4 text-white">Loading pages...</p>
              </div>
            ) : rootPages.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-[#333] bg-[#0f0f10] p-12 text-center">
                ...
                <h3 className="mb-2 text-xl font-medium text-white">No pages yet</h3>
                <p className="mb-6 text-gray-400">Create your first page to get started</p>
                <Button
                  size="sm"
                  onClick={handleCreatePage}
                  className="bg-[#141415] text-white border-[#ffffff1f] hover:bg-[#1a1a1a] hover:text-white"
