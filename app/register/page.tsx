...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error, success } = await signUp(email, password, displayName)
      ...
      <div className="w-full max-w-md">
        ...
        {success ? (
          <div className="rounded-lg border border-[#333] bg-[#1a1a1a] p-8 shadow-lg">
            <div className="rounded-lg bg-green-900/30 p-8 text-center">
          ...
          <div className="rounded-lg border border-[#333] bg-[#1a1a1a] p-8 shadow-lg">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group relative flex w-full items-center justify-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:bg-indigo-800 disabled:opacity-70"
              >
                {isLoading ? (
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-700 bg-[#1a1a1a] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#252525] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-70"
              >
                {isGoogleLoading ? (
