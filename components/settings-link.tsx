...
export function SettingsLink({ isCollapsed, onCloseMobileSidebar }: SettingsLinkProps) {
  ...
  return (
    <button
      ...
      } items-center gap-2 rounded-md px-2 py-1.5 text-left text-sm transition-colors duration-200 text-gray-400 hover:bg-[#1a1a1a] hover:text-white rtl:text-right`}
      onClick={handleClick}
    >
